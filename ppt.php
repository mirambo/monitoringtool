...
echo $batchID;
   ...
   $query5 = "SELECT * FROM ppt_perfomance WHERE GrpNo = $groupID AND batch = $batchID ORDER BY Minutes DESC";
...
mysqli_select_db($dbconfig,"monitoring") or die("cannot select DB");
                ...
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
							...
							<center>
							<center><div class="alert alert-success" role="alert"><b>POWERPOINT REPORT </b></div></center>
							</center>
					...
					<div class="row">
                                ...
                                <div class="col-sm-2" >
                                          <?php
                                                $query3 = "SELECT COUNT(*) AS TOTAL FROM ppt_perfomance WHERE Status ='Finished' AND grpNo = $groupID AND batch = $batchID";
                                                  ...
                                                  {
                                                  ?>
                                                    <div><center><h1 style="color:#668080"><b>Finished</b></h1><h2> Above 150 Mins</h2></center></div>
									...
									<div class="col-sm-3" >
												<?php
												  $query1 = "SELECT COUNT(*) AS TOTAL FROM ppt_perfomance WHERE Status ='Average' AND grpNo = $groupID AND batch = $batchID";
													...
													{
												?>
													<div><center><h1 style="color:#668080"><b>Average</b></h1><h2> 90 - 149 Mins</h2></center></div>
                                    ...
                                    <div class="col-sm-3" >
                                          <?php
                                                $query4 = "SELECT COUNT(*) AS TOTAL FROM ppt_perfomance WHERE Status ='Incomplete' AND grpNo = $groupID AND batch = $batchID";
                                                  ...
                                                  {
                                                  ?>
                                                    <div><center><h1 style="color:#668080"><b>Incomplete</b></h1><h2> 1 - 89 Mins</h2></center></div>
                          ...
                          <div class="col-sm-3" >
                          <?php
                                $query2 = "SELECT COUNT(*) AS TOTAL FROM ppt_perfomance WHERE Status ='Absent' AND grpNo = $groupID AND batch = $batchID";
    ...
    <div class="row">
        ...
        <table class="table table-hover"   cellspacing="0" width="100%" data-toggle="table"  data-pagination="true"  data-search="true">
			  ...
			  $result3 = mysqli_query($connection,"SELECT * FROM ppt_perfomance  WHERE grpNo = $groupID AND batch = $batchID" );
