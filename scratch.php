...
echo $batchID;
   ...
   $query5 = "SELECT * FROM scratch_perfomance WHERE GrpNo = $groupID AND batch = $batchID ORDER by Minutes DESC";
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
					...
					<div class="row">
                                ...
                                <div class="col-sm-2" >
                                          <?php
                                                $query3 = "SELECT COUNT(*) AS TOTAL FROM scratch_perfomance WHERE Status ='Finished' AND grpNo = $groupID AND batch = $batchID";
									...
									<div class="col-sm-3" >
												<?php
												  $query1 = "SELECT COUNT(*) AS TOTAL FROM scratch_perfomance  WHERE Status = 'Average'  AND grpNo = $groupID AND batch = $batchID";
                                    ...
                                    <div class="col-sm-3" >
                                          <?php
                                                $query4 = "SELECT COUNT(*) AS TOTAL FROM scratch_perfomance WHERE Status = 'Incomplete' AND grpNo = $groupID AND batch = $batchID";
									  ...
									  <div class="col-sm-3" >
										  <?php
											$query2 = "SELECT COUNT(*) AS TOTAL FROM scratch_perfomance WHERE Status = 'Absent' AND grpNo = $groupID AND batch = $batchID";
    ...
    <div class="row">
        ...
        <table class="table table-hover"   cellspacing="0" width="100%" data-toggle="table"  data-pagination="true"  data-search="true">
          ...
          <th scope="col">Batch</th>
			  ...
			  $result3 = mysqli_query($connection,"SELECT * FROM scratch_perfomance  WHERE grpNo = $groupID AND batch = $batchID" );
