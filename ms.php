...
echo $batchID;
   ...
   $query5 = "SELECT * FROM ms_perfomance WHERE GrpNo = $groupID AND batch = $batchID ORDER BY Minutes DESC";
...
<head>
 ...
 var chart = new CanvasJS.Chart("chartContainer", {
   ...
   axisY:{
    maximum: 1000 , title: 'Minutes',

			stripLines:[
			{                
				startValue:300,
				endValue:0,
        label: "Fail/incomplete",
                ...
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
							...
							<center>
							<center><div class="alert alert-success" role="alert"><b>MS REPORT </b></div></center>
							</center>
							...
							<center>
							<a href="deleteafter.php?group=<?php echo $groupID; ?>&batch=<?php echo $batchID; ?>"><button type="submit" class="btn btn-info"><b>Ms Word </b></button></a>                  
					...
					<div class="row">
                                ...
                                <div class="col-sm-2" >
                                          <?php
                                                $query3 = "SELECT COUNT(*) AS TOTAL FROM ms_perfomance WHERE Status ='Finished' AND grpNo = $groupID AND batch = $batchID";
                                                  ...
                                                  {
                                                  ?>
                                                    <div><center><h1 style="color:#668080"><b>Finished</b></h1><h2> Above 500 Mins</h2></center></div>
                                                    <div><center><p style="font-size:30px; color:#668080;"><b><?php echo $row3[0];?></b></p></center></div>
                                                    <?php } ?>
                                                    <div><hr style="height:1px;border-width:0;color:gray;background-color:gray"></div>
                                    </div>

									
										<div class="col-sm-3" >
											<?php
											  $query1 = "SELECT COUNT(*) AS TOTAL FROM ms_perfomance  WHERE Status = 'Average'  AND grpNo = $groupID AND batch = $batchID";
												...
												{
											?>
												<div><center><h1 style="color:#668080"><b>Average</b></h1><h2> 300 - 499 Mins</h2></center></div>
												<div><center><p style="font-size:30px; color:#668080;"><b><b><?php echo $row1[0];?></b></p></center></div>
												<?php } ?>
												<div><hr style="height:1px;border-width:0;color:gray;background-color:gray"></div>
									  </div>
                                    ...
                                    <div class="col-sm-3" >
                                          <?php
                                                $query4 = "SELECT COUNT(*) AS TOTAL FROM ms_perfomance WHERE Status = 'Incomplete' AND grpNo = $groupID AND batch = $batchID";
                                                  ...
                                                  {
                                                  ?>
                                                    <div><center><h1 style="color:#668080"><b>Incomplete</b></h1><h2> 1 - 299 Mins</h2></center></div>
                                                    <div><center><p style="font-size:30px; color:#668080;"><b><?php echo $row4[0];?></b></p></center></div>
                                                    <?php } ?>
                                                    <div><hr style="height:1px;border-width:0;color:gray;background-color:gray"></div>
                                    </div>
                          ...
                          <div class="col-sm-3" >
                          <?php
                                $query2 = "SELECT COUNT(*) AS TOTAL FROM ms_perfomance WHERE Status = 'Absent' AND grpNo = $groupID AND batch = $batchID";
                                  ...
                                  {
                                  ?>
                                    <div><center><h1 style="color:#668080"><b>Absent</b></h1><h2> Less Than 1 Min</h2></center></div>
                                    <div><center><p style="font-size:30px; color:#668080;"><b><?php echo $row2[0];?></b></p></center></div>
                                    <?php } ?>
                                    <div><hr style="height:1px;border-width:0;color:gray;background-color:gray"></div>
                          </div>  
          </div>
    ...
    <div class="row">
        ...
        <table class="table table-hover"   cellspacing="0" width="100%" data-toggle="table"  data-pagination="true"  data-search="true">
          ...
          <th scope="col">Group</th>
			  ...
			  $result3 = mysqli_query($connection,"SELECT * FROM ms_perfomance  WHERE grpNo = $groupID AND batch = $batchID" );
