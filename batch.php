                ...
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
							...
							<div>
						   <center>
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=1"><button type="button" class="btn btn-info" ><b>January </button></a> 
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=2"><button type="button" class="btn btn-info" ><b>February </button></a> 
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=3"><button type="button" class="btn btn-info" ><b>March</button></a> 
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=4"><button type="button" class="btn btn-info" ><b>April</button></a> 
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=5"><button type="button" class="btn btn-info" ><b>May</button></a>
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=6"><button type="button" class="btn btn-info" ><b>June</button></a> 							   
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=7"><button type="button" class="btn btn-info" ><b>July</button></a> 
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=8"><button type="button" class="btn btn-info" ><b>August</button></a> 
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=9"><button type="button" class="btn btn-info" ><b>September</button></a> 
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=10"><button type="button" class="btn btn-info" ><b>October</button></a> 
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=11"><button type="button" class="btn btn-info" ><b>November</button></a>
						   <a href="dashboard.php?ID=<?php echo $groupID ?>&batch=12"><button type="button" class="btn btn-info" ><b>December</button></a>
