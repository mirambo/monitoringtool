...
<div class="row">
        ...
        <table class="table table-hover"   cellspacing="0" width="100%" data-toggle="table"  data-pagination="true"  data-search="true">
			  <thead>
								...
								<th scope="col">TrainingCenter</th>
                                ...
                                $result3 = mysqli_query($connection,"SELECT * FROM data_group  WHERE grpNo = $groupID AND batch = $batchID  GROUp by Name" );
								...
								<td><a href="student_details.php?name=<?php echo $row3['1']; ?>"><?php echo $row3['1']; ?></a></td>	
