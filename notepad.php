...
echo $batchID;
   ...
   $query5 = "SELECT * FROM notepad_perfomance WHERE GrpNo = $groupID AND batch = $batchID ORDER BY Minutes DESC";
                ...
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
							...
							<center>
							<center><div class="alert alert-success" role="alert"><b>NOTEPAD REPORT </b></div></center>
							</center>
					...
					<div class="row">
                                ...
                                <div class="col-sm-2" >
                                          <?php
                                                $query3 = "SELECT COUNT(*) AS TOTAL FROM notepad_perfomance WHERE Status ='Finished' AND grpNo = $groupID AND batch = $batchID";
									...
									<div class="col-sm-3" >
												<?php
												  $query1 = "SELECT COUNT(*) AS TOTAL FROM notepad_perfomance WHERE Status ='Average' AND grpNo = $groupID AND batch = $batchID";
                                    ...
                                    <div class="col-sm-3" >
                                          <?php
                                                $query4 = "SELECT COUNT(*) AS TOTAL FROM notepad_perfomance WHERE Status ='Incomplete' AND grpNo = $groupID AND batch = $batchID";
										  ...
										  <div class="col-sm-3" >
										  <?php
												$query2 = "SELECT COUNT(*) AS TOTAL FROM notepad_perfomance WHERE Status ='Absent' AND grpNo = $groupID AND batch = $batchID";
    ...
    <div class="row">
        ...
        <table class="table table-hover"   cellspacing="0" width="100%" data-toggle="table"  data-pagination="true"  data-search="true">
          ...
          <th scope="col">Group</th>
			  ...
			  $result3 = mysqli_query($connection,"SELECT * FROM notepad_perfomance  WHERE grpNo = $groupID AND batch = $batchID" );
